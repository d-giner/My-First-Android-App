...
public class MainActivity extends AppCompatActivity {
    ...
    /** Es necessari crear una variable per a cada botó i text view */
    private Button zero;
    private Button one;
    private Button two;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupUIViews(); /** Iniciem les variables, botons i textViews */
    ...
    private void setupUIViews() { /** Funció per assignar els nostres botons i textViews a les variables */
        ...
        rest = findViewById(R.id.btRest);
        mult = findViewById(R.id.btMult);
        div = findViewById(R.id.btDiv);
        dec = findViewById(R.id.btDec);
        result = findViewById(R.id.btResul);
        clear = findViewById(R.id.btClear);
        clearAll = findViewById(R.id.btClearAll);
        resultadoText = findViewById(R.id.resText);
        operacionText = findViewById(R.id.opText);
    }

    private void Calcular() { /** Es filtren les xifres i l'operació dessitjada */
        switch (accion) {
            case '+':
    ...
    private void newOp(){ /** Per reinicialitzar els Text views i prevenció de multioperació */
        accion = 'f';
        borrado = false;
        operacionText.setText("");
        resultadoText.setText("");
